                            ...
                            <div class="row">
                                <div class="col-sm-12 col-md-8">
                                    ...
                                    <div class="mb-2 w-100 mb-4 mt-4">
                                        ...
                                        <textarea class="w-100" rows="4" name="task_body" id="task_body">

                                            {{ old('task_body', $task->task_body) }}
                                        </textarea>
                                    </div>
                                    <span class="text-danger error-text task_body_error"></span>


                                    <div class="d-flex mb-4 float-end">
                                ...
                                <div class="col-sm-12 col-md-4 mb-5">
                                    ...
                                    <select class="form-control w-100" id="status" name="status">
                                        ...
                                        <option value="assin" {{ $task->status == 'assin' ? 'selected' : '' }}>Assign</option>
                                    ...
                                    <div id="image_div">
                                        ...
                                        src="{{ asset('storage/task-image/' . $task->image) }}" 
